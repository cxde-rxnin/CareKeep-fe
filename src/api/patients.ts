...
export const updatePatient = (id: string, payload: any) => client.put(`/patients/${id}`, payload)
export const updatePatientStatus = (id: string, payload: any) => client.patch(`/patients/${id}/status`, payload)
